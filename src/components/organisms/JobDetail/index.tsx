  ...
  return (
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
          ...
          <div>
            ...
            <div className="text-gray-500 mt-4">
              <p>
                ...
                laudantium aspernatur, repudiandae totam ratione laboriosam
                itaque suscipit, quos repellat, illo officia laborum quia sequi?
                Repellendus dignissimos illo nulla repellat suscipit.
              </p>
            </div>
          </div>
          <div>
        ...
        <div>
          <div className="text-3xl font-semibold">About his role</div>
          ...
          {[0, 1, 2].map((item: number) => (
            <div key={item}>
              ...
              <div className="text-gray-500">
                ...
                atque quas praesentium unde itaque ratione deserunt magni nemo
                veniam! Distinctio provident natus assumenda reiciendis delectus
                architecto voluptates nostrum. Quae, vitae.
              </div>
            </div>
          ))}
        </div>
